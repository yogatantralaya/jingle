...
<body>
	<div class="home">
		<div class="div">
			<div class="top-bar">
				<div class="search">
					<i class="material-symbols-outlined">search</i> <input
						class="search-artist-title" placeholder="search song" type="text" />
				</div>
				<div class="greetings">
					<h3 style="color: white">${Greetings}
			...
			<div class="content">
				...
				<div class="pics">
					<i class="material-symbols-outlined">arrow_back_ios</i> <img
						class="element" src="media/deafult_album_cover.jpg" /> <img
						class="element" src="media/deafult_album_cover.jpg" /> <img
						class="element" src="media/deafult_album_cover.jpg" /> <img
						class="element" src="media/deafult_album_cover.jpg" /> <img
						class="element" src="media/deafult_album_cover.jpg" /> <img
						class="element" src="media/deafult_album_cover.jpg" /> <i
						class="material-symbols-outlined">arrow_forward_ios</i>
				</div>
				...
				<div class="pics">
					...
					<div class="element-2">
						<div class="frame-2">
							<img class="element" src="media/deafult_album_cover.jpg" />
							<!-- <div class="image"></div> -->
						...
						<div class="frame-3">
							<div class="frame-4">
								...
								<div class="frame-5">
									<div class="text-wrapper-5">Super Shy</div>
									<div class="text-wrapper-6">NewJeans • 2:34</div>
								</div>
							</div>
							<div class="frame-4">
								<div class="div-wrapper">
							...
							<div class="frame-6">
								...
								<div class="frame-5">
									<div class="text-wrapper-5">Somebody’s Pleasure</div>
									<div class="text-wrapper-6">Aziz Hedra • 3:44</div>
								</div>
							</div>
							<div class="frame-6">
								<div class="div-wrapper">
								...
								<div class="frame-5">
									...
									<div class="text-wrapper-6">BLACKPINK • 3:04</div>
								</div>
							</div>
						</div>
					</div>
				...
				<div class="pics">
					...
					<c:forEach var="tempArtist" items="${Artist_List}">
						<div>
							<img class="element" src="${tempArtist.location}" />
						</div>
					</c:forEach>
					<i class="material-symbols-outlined">arrow_forward_ios</i>
				</div>
			...
			<div class="now-playing">
				<img class="now-playing-2" src="media/deafult_album_cover.jpg" /> 
				<i class="material-symbols-outlined">graphic_eq</i>
				<div id="audio">
					<audio id="myAudio"></audio>
					<div>
						<input type="range" id="progressControl" min="0" max="100" value="0"
							step="1" oninput="setPlaybackPosition()">
					</div>
					<div class="controls">
						<button>
				...
				<button onclick="toggleMute()">
					...
					<input id="volumeControl" type="range" min="0" max="100"
						value="100" step="1" oninput="setVolume()">
			</div>
			<div class="navigation-bar">
				<div class="logo">
					<img class="logo-side" src="images/jingle_logo.jpeg" />
					<h1 style="font-family: Tangerine; color: #ab8742">ingle</h1>
				</div>
				<div class="div-3">
					...
					<div class="frame-11">
						<div class="menu-wrapper">
							<div class="menu-2">
								...
								<div class="text-wrapper-15">Recommended</div>
							</div>
						</div>
						<div class="menu-wrapper">
							<div class="menu-2">
					...
					<div class="frame-11">
						<div class="menu-wrapper">
							<div class="menu-2">
								...
								<div class="text-wrapper-15">Trending Songs</div>
							</div>
						</div>
						<div class="menu-wrapper">
							<div class="menu-2">
	...
	<script>
		...
		const audioSources = [ 'media/matargashti.mp3', 'media/safarnama.mp3',
		...
		function updatePlayPauseButton() {
			...
			playPauseButton.innerHTML = isPlaying ? '<i class="material-symbols-outlined">pause</i>'
					: '<i class="material-symbols-outlined">play_arrow</i>';
		}

		function updateVolumeControl() {
			const volumeControl = document.getElementById('volumeControl');
			volumeControl.value = audioPlayer.muted ? 0
		...
		function updateLoopIcon() {
			loopIcon.textContent = isLooped ? '<i class="material-symbols-outlined">repeat_one</i>'
					: '<i class="material-symbols-outlined">repeat</i>';
		}
		...
		function setPlaybackPosition() {
			audioPlayer.currentTime = (progressControl.value / 100)
